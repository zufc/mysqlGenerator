...
import com.cbecs.generator.util.SQLFormatter;

public class TableDataPanel extends BasePanel
{
    private static final long serialVersionUID = 2241141942042777333L;
    private String sql = "";
    ...
    {
        // UIManager.put("TabbedPane.tabAreaInsets", new InsetsUIResource(3, 20,
        // 2, 20));
