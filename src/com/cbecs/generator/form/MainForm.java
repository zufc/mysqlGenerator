...
import com.cbecs.generator.main.CreateThread;
...
public class MainForm extends BasePanel
{
    ...
    public void initCompant()
    {
        ...
        saveBtn.setBounds(left + (labelWidth + 10) * 2 + textWidth + 50, labelTextHeight + 20, textWidth - 60, labelTextHeight);
        add(saveBtn);

        newSaveBtn = new JButton("另存为");
        newSaveBtn.setBounds(left + (labelWidth + 10) * 2 + textWidth * 2, labelTextHeight + 20, textWidth - 60, labelTextHeight);
        add(newSaveBtn);
        ...
        add(dbFrameLabel);
        dbFrameCombo = new JComboBox<Object>(new Object[]
        { "Mybatis" });
        ...
        packageLabel.setBounds(left + labelWidth + textWidth + 10, top + ((labelTextHeight + 10) * 2), labelWidth, labelTextHeight);
        add(packageLabel);
        entPackageText = new JTextField("");
        entPackageText.setName("entityPackage");
        entPackageText.setBounds(left + labelWidth * 2 + textWidth + 10, top + ((labelTextHeight + 10) * 2), textWidth * 2, labelTextHeight);
        add(entPackageText);
        ...
        packageLabel2.setBounds(left + labelWidth + textWidth + 10, top + ((labelTextHeight + 10) * 3), labelWidth, labelTextHeight);
        add(packageLabel2);
        daoPackageText = new JTextField("");
        daoPackageText.setName("daoPackage");
        daoPackageText.setBounds(left + labelWidth * 2 + textWidth + 10, top + ((labelTextHeight + 10) * 3), textWidth * 2, labelTextHeight);
        add(daoPackageText);
        ...
        packageLabel3.setBounds(left + labelWidth + textWidth + 10, top + ((labelTextHeight + 10) * 4), labelWidth, labelTextHeight);
        // add(packageLabel3);
        mapPackageText = new JTextField("");
        mapPackageText.setName("mapPackage");
        mapPackageText.setBounds(left + labelWidth * 2 + textWidth + 10, top + ((labelTextHeight + 10) * 4), textWidth * 2, labelTextHeight);
        // add(mapPackageText);
        hbmPackageText = new JTextField("");
        hbmPackageText.setName("hbmPackage");
        hbmPackageText.setBounds(left + labelWidth * 2 + textWidth + 10, top + ((labelTextHeight + 10) * 4), textWidth * 2, labelTextHeight);
        add(hbmPackageText);
        ...
        add(cFrameLabel);
        cFrameCombo = new JComboBox<Object>(new Object[]
        { "SpringMVC" });
        ...
        packageLabel7.setBounds(left + labelWidth + textWidth + 10, top + ((labelTextHeight + 10) * 8), labelWidth, labelTextHeight);
        add(packageLabel7);
        cotPackageText = new JTextField("");
        cotPackageText.setName("cotPackage");
        cotPackageText.setBounds(left + labelWidth * 2 + textWidth + 10, top + ((labelTextHeight + 10) * 8), textWidth * 2, labelTextHeight);
        add(cotPackageText);
        actPackageText = new JTextField("");
        actPackageText.setName("actPackage");
        actPackageText.setBounds(left + labelWidth * 2 + textWidth + 10, top + ((labelTextHeight + 10) * 8), textWidth * 2, labelTextHeight);
        add(actPackageText);
    ...
    public void initCombo()
    {
        ...
        initValue(reader.getConfig(config_section, "Config 1"));
    ...
    public void initTreeThread(int flag)
    {
        ...
        {
            /*
             * int count = dbNode.getChildCount(); if(count > 0){ }
             */
            return;
        }
        new Thread()
            ...
            { // node.isLeaf() //node.isRoot()
                ...
                if (User != null)
                {
                    ...
                    { // 表层
                        ...
                        setCompTooltip();
                        /*
                         * if (count == 0) { initTableFeild(node, table); }
                         */
                    }
                    else if (level == 2)
                    { // 字段层
    ...
    public CreAttr getCreAttr(List<String> tables)
    {
        ...
        if (daoBox.isSelected())
        {
            ...
            ca.setMapperName(entityName + "Mapper");
            ca.setMapperPackage(Utililies.getRealPackage(daoPackageText.getText()) + "." + ca.getMapperName());
            ca.setMapperFilePath(Utililies.packageToDir(Utililies.getRealPackage(daoPackageText.getText()) + "/") + ca.getMapperName() + ".xml");
        }
        if (serviceBox.isSelected())
        {
            ca.setServiceName(entityName + "Service");
            ca.setServiceImplName(entityName + "ServiceImpl");
            ca.setServicePackage(Utililies.getRealPackage(serPackageText.getText()) + ".inf." + ca.getServiceName());
            ca.setServiceImplPackage(Utililies.getRealPackage(serPackageText.getText()) + ".impl." + ca.getServiceImplName());
            ca.setServiceFilePath(Utililies.packageToDir(Utililies.getRealPackage(serPackageText.getText()) + "/inf/") + ca.getServiceName() + ".java");
            ca.setServiceImplFilePath(Utililies.packageToDir(Utililies.getRealPackage(serPackageText.getText()) + "/impl/") + ca.getServiceImplName() + ".java");
        }
